...
double mcts_child_potential(MCTSNode* child,
                            int total_tries);
...
int mcts_simulate(MCTSNode* parent, Board& board,
                  Subs& empty_spots, int& total_empty, int play_move_result);
std::vector<MCTSNode*> mcts_get_children(
    MCTSNode* parent, Board& board);
